            ...
            .any(|component| component == "" || component == "." || component == "..")
        {
            ...
            for component in result.components() {
                match component {
                    ...
                    other => normalized.push(Self::new_unchecked(other)),
                }
            }
...
impl RelPathBuf {
    ...
    pub fn push(&mut self, path: &RelPath) {
        ...
        self.0.push_str(path.as_unix_str());
    }
...
mod tests {
    ...
    fn test_rel_path() {
        ...
        let path = RelPath::new(".\\foo".as_ref(), PathStyle::Windows).unwrap();
        assert_eq!(path.as_ref(), rel_path("foo"));
        assert_matches!(path, Cow::Borrowed(_));
    ...
    fn test_rel_path_strip_prefix() {
        ...
        assert_matches!(
            rel_path("foo").strip_prefix(rel_path("bar")),
            Err(StripPrefixError)
        );
    }
