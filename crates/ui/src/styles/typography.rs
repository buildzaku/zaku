...
impl TextSize {
    pub fn rems(self, cx: &App) -> Rems {
        ...
        match self {
            Self::Large => crate::rems_from_px(16.0_f32),
            Self::Default => crate::rems_from_px(14.0_f32),
            Self::Small => crate::rems_from_px(12.0_f32),
            Self::XSmall => crate::rems_from_px(10.0_f32),
