    ...
    let (colors, status) = match appearance {
        Appearance::Dark => {
            let colors = ThemeColors {
                ...
                editor_line_number: gpui::rgb(0x4e5a5f).into(),
                editor_active_line_number: gpui::rgb(0xd0d4da).into(),
        ...
        Appearance::Light => {
            let colors = ThemeColors {
                ...
                editor_line_number: gpui::rgb(0xb4b4bb).into(),
                editor_active_line_number: gpui::rgb(0x44454b).into(),
