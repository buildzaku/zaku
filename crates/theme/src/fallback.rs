    ...
    let (colors, status, syntax) = match appearance {
        Appearance::Dark => {
            let colors = ThemeColors {
                ...
                button_background: gpui::rgb(0x313233).into(),
                button_foreground: gpui::rgb(0xc3c3c3).into(),
                button_hover_background: gpui::rgb(0x201f1f).into(),
                button_border: Hsla::transparent_black(),
                button_secondary_background: Hsla::transparent_black(),
                button_secondary_foreground: gpui::rgb(0xc3c3c3).into(),
                button_secondary_hover_background: gpui::rgb(0x313233).into(),
                button_secondary_border: gpui::rgb(0x333333).into(),
            ...
            let status = StatusColors {
                ...
                created: gpui::rgb(0xa3be8c).into(),
                created_background: gpui::rgba(0xa3be8c1a).into(),
                created_border: gpui::rgb(0x365d36).into(),
                deleted: gpui::rgb(0xbf616a).into(),
                deleted_background: gpui::rgba(0xbf616a1a).into(),
                ...
                ignored: gpui::rgb(0x505050).into(),
                ignored_background: gpui::rgba(0x5050501a).into(),
                ...
                modified: gpui::rgb(0xc0b397).into(),
                modified_background: gpui::rgba(0xc0b3971a).into(),
                modified_border: gpui::rgb(0x776849).into(),
                renamed: gpui::rgb(0xa3be8c).into(),
                renamed_background: gpui::rgba(0xa3be8c1a).into(),
                renamed_border: gpui::rgb(0x365d36).into(),
                success: gpui::rgb(0xa1c181).into(),
                success_background: gpui::rgba(0xa1c1811a).into(),
                success_border: gpui::rgb(0x365d36).into(),
        ...
        Appearance::Light => {
            let colors = ThemeColors {
                ...
                button_background: gpui::rgb(0xdcdfe0).into(),
                button_foreground: gpui::rgb(0x5f5f5f).into(),
                button_hover_background: gpui::rgb(0xf0f0f2).into(),
                button_border: Hsla::transparent_black(),
                button_secondary_background: Hsla::transparent_black(),
                button_secondary_foreground: gpui::rgb(0x5f5f5f).into(),
                button_secondary_hover_background: gpui::rgb(0xdcdfe0).into(),
                button_secondary_border: gpui::rgb(0xd0d0d0).into(),
            ...
            let status = StatusColors {
                ...
                conflict_background: gpui::rgba(0xdec1841a).into(),
                conflict_border: gpui::rgb(0x5d4c2f).into(),
                created: gpui::rgb(0x139413).into(),
                created_background: gpui::rgba(0x1394131a).into(),
                created_border: gpui::rgb(0x365d36).into(),
                deleted: gpui::rgb(0xff0000).into(),
                deleted_background: gpui::rgba(0xff00001a).into(),
                deleted_border: gpui::rgb(0x4c2b2c).into(),
                error: gpui::rgb(0xd07277).into(),
                error_background: gpui::rgba(0xd072771a).into(),
                error_border: gpui::rgb(0x4c2b2c).into(),
                ...
                ignored: gpui::rgb(0x999999).into(),
                ignored_background: gpui::rgba(0x9999991a).into(),
                ...
                modified: gpui::rgb(0xaf864a).into(),
                modified_background: gpui::rgba(0xaf864a1a).into(),
                modified_border: gpui::rgb(0x785f3b).into(),
                renamed: gpui::rgb(0x139413).into(),
                renamed_background: gpui::rgba(0x1394131a).into(),
                renamed_border: gpui::rgb(0x365d36).into(),
