    ...
    let (colors, status, syntax) = match appearance {
        Appearance::Dark => {
            ...
            let status = StatusColors {
                ...
                modified: gpui::rgb(0x6d8cbf).into(),
                modified_background: gpui::rgba(0x6d8cbf1a).into(),
                modified_border: gpui::rgb(0x2b3e5e).into(),
                renamed: gpui::rgb(0xa3be8c).into(),
                renamed_background: gpui::rgba(0xa3be8c1a).into(),
                renamed_border: gpui::rgb(0x38482f).into(),
        ...
        Appearance::Light => {
            ...
            let status = StatusColors {
                ...
                conflict_background: gpui::rgba(0xdec1841a).into(),
                conflict_border: gpui::rgb(0x5d4c2f).into(),
                created: gpui::rgb(0x00aa00).into(),
                created_background: gpui::rgba(0x00aa001a).into(),
                created_border: gpui::rgb(0x38482f).into(),
                ...
                modified: gpui::rgb(0x286ebd).into(),
                modified_background: gpui::rgba(0x286ebd1a).into(),
                modified_border: gpui::rgba(0x2160a660).into(),
                renamed: gpui::rgb(0x00aa00).into(),
                renamed_background: gpui::rgba(0x00aa001a).into(),
                renamed_border: gpui::rgb(0x38482f).into(),
