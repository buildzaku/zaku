...
export type RequestConfig = { method: string, url?: string, headers?: Array<[boolean, string, string]>, parameters?: Array<[boolean, string, string]>, content_type?: string, body?: string, };
